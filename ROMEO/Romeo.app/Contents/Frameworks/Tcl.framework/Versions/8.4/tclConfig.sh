...
# build directory.
TCL_BUILD_LIB_SPEC='-F/var/tmp/tcl/tcl-87~296/tcl84/Deployment -framework Tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl/tcl-87~296/tcl84/Deployment -ltclstub8.4${TCL_DBGX}'
...
TCL_BUILD_STUB_LIB_PATH='/var/tmp/tcl/tcl-87~296/tcl84/Deployment/libtclstub8.4${TCL_DBGX}.a'

...
proc tcl::DarwinFixAutoPath {} {
    if {[lsearch -exact $::auto_path /System/Library/Tcl/8.4] == -1 && [lsearch -exact $::auto_path /System/Library/Tcl] != -1} {
	foreach g {::auto_path ::tcl_pkgPath} {
	    set $g [linsert [set $g] [expr {[lsearch -exact [set $g] /System/Library/Tcl]+1}] /System/Library/Tcl/8.4]
	}
    }
    if {[lsearch -exact $::auto_path /System/Library/Frameworks/Tk.framework/Versions/8.4/Resources] == -1 && [lsearch -exact $::auto_path /System/Library/Frameworks] != -1} {
	set ::auto_path [linsert $::auto_path [expr {[lsearch -exact $::auto_path /System/Library/Frameworks]+1}] /System/Library/Frameworks/Tk.framework/Versions/8.4/Resources]
    }
}

...
# build directory.
TK_BUILD_LIB_SPEC='-F/var/tmp/tcl/tcl-87~272/tk84/Deployment -framework Tk'
...
# compiled.
TK_SRC_DIR='/SourceCache/tcl/tcl-87/tk84/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl/tcl-87~272/tk84/Deployment -ltkstub8.4'
...
TK_BUILD_STUB_LIB_PATH='/var/tmp/tcl/tcl-87~272/tk84/Deployment/libtkstub8.4.a'

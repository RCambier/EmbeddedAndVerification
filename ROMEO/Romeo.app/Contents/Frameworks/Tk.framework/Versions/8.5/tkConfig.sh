...
# build directory.
TK_BUILD_LIB_SPEC='-F/var/tmp/tcl/tcl-87~272/tk/Deployment -framework Tk'
...
# compiled.
TK_SRC_DIR='/SourceCache/tcl/tcl-87/tk/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl/tcl-87~272/tk/Deployment -ltkstub8.5'
...
TK_BUILD_STUB_LIB_PATH='/var/tmp/tcl/tcl-87~272/tk/Deployment/libtkstub8.5.a'
